...
Extract from Resume button — nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free reads uploaded PDF and auto-fills profile form fields.
...
- nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free via OPEN ROUTER reads extracted text and returns structured JSON matching all profile field names
...
Generate a clean professional PDF resume from current profile data using nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free.

**Logic:**

- POST /api/resume/generate
- Reads current profile data from profiles table
- nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free generates professional resume content:
  - Professional summary paragraph
  - Polished work experience bullet points
  - Clean professional language throughout
- @react-pdf/renderer renders nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free output into clean single-page PDF using renderToBuffer()
...
- For each job returned:
  ...
  - nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free scores job against user profile:
...
- AI Match Reasoning section — match reason paragraph from nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free
...
- Derive company homepage URL by following the Adzuna redirect with server-side fetch() — no browser needed for this step:
  ...
  - If Stagehand gets no meaningful content (oneLiner and productSummary empty) — skip browser research entirely, proceed to nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free synthesis with job description and profile only
...
- Close Browserbase session after homepage + max 3 sub-pages
  **nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free synthesis (runs after browser closes):**
...
- Always return a dossier — never fail silently. If browser research failed, nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free synthesizes from job description and profile alone.
